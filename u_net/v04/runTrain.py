    ...
    for epoch in range(epochs):
        ...
        for i, validata in enumerate(valiLoader, 0):
            ...
            if i==0 and epoch % 5 == 0:
                inputs_denormalized = utils.normalize(inputs_cpu.cpu().numpy()[0])
                ...
                utils.fullImageOut("results_train/epoch{}_{}".format(epoch, i), inputs_denormalized, outputs_denormalized, targets_denormalized, saveTargets=True)
                plt.close('all')
        pbar.update(1)
