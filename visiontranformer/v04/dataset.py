...
class TrainDataset(Dataset):
    ...
    def __init__(self, mode=TRAIN):
        ...
        if not self.mode==self.TEST:
            ...
            self.testInputs = self.inputs[targetLength:]
            self.testTargets = self.targets[targetLength:]
            self.testLength = self.totalLength - targetLength
...
class TestDataset(TrainDataset):
    def __init__(self, dataset): 
        self.inputs = dataset.testInputs
        self.targets = dataset.testTargets
        self.totalLength = dataset.testLength
